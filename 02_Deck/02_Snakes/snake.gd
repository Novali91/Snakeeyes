...
func _ready() -> void:
	...
	match current_drink.rarity:
		...
		"L":
			attached_snake.snake_name = "[wave amp=50.0 freq=5.0 connected=1][rainbow freq=2.0 sat=1.0 val=0.8 speed=0.7]" + attached_snake.snake_name
			current_drink.drink_name = "[wave amp=50.0 freq=5.0 connected=1][rainbow freq=2.0 sat=1.0 val=0.8 speed=0.7]" + current_drink.drink_name
